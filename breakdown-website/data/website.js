...
window.breakdownWebsiteData.website = {
  ...
  highLevelVariables: [
    {
      ...
      notes:
        "The link starts on the latest GitHub Release page, then client detection may switch macOS users to BranchTracker.dmg.",
    },
    {
  ...
  | { type: "latestReleasePage"; href: "https://github.com/glassdevtools/branchtracker/releases/latest" }
  | { type: "macDmg"; href: "https://github.com/glassdevtools/branchtracker/releases/latest/download/BranchTracker.dmg" };`,
    },
    {
  ...
  detect -->|macOS desktop| mac["Download href: BranchTracker.dmg"]
  ...
  backendProducts: [
    ...
    },
    {
      ...
      neededOutsideRepo:
        "A public latest release and a static BranchTracker.dmg asset for direct macOS downloads.",
      expectedSource:
    ...
    },
    {
      ...
      expectedSource: "https://github.com/glassdevtools/branchtracker.",
    },
    {
  ...
  features: [
    ...
    },
    {
      ...
      backendResponses: [
        "GitHub serves the latest release page or BranchTracker.dmg.",
    ...
    },
    {
      ...
      stateChanges: [
        ...
        "macOS sets the href to BranchTracker.dmg.",
