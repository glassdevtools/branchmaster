...
const createRepo = async () => {
    const repoRoot = await (0, promises_1.realpath)(await (0, promises_1.mkdtemp)((0, node_path_1.join)((0, node_os_1.tmpdir)(), "branchtracker-git-")));
    await runGit({
        cwd: repoRoot,
...
const createRepoWithOrigin = async () => {
    const parentRoot = await (0, promises_1.realpath)(await (0, promises_1.mkdtemp)((0, node_path_1.join)((0, node_os_1.tmpdir)(), "branchtracker-git-origin-")));
