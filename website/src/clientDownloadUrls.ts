export const CLIENT_DOWNLOAD_PAGE_PATH =
  "https://github.com/glassdevtools/branchtracker/releases/latest";
...
const clientDownloads: ClientDownload[] = [
  {
    platform: "macos",
    href: "https://github.com/glassdevtools/branchtracker/releases/latest/download/BranchTracker.dmg",
  },
];
